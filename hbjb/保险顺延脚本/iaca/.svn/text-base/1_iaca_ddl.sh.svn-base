...
echo "==============================================="
echo "创建KSCMain_NCP-CONFIRMSEQUENCENO索引"
echo "==============================================="
...
echo "==============================================="
echo "创建CAPolicyNoPost_NCP-疫情期不延期保单表"
echo "==============================================="
db2 "create table CAPolicyNoPost_NCP
(
	ConfirmSequenceNo 	VARCHAR(50) not null,
	PolicyNo	VARCHAR(50),
	LicenseNo 	VARCHAR(15),
	...
	Desc	VARCHAR(2000),
	InputDate	TIMESTAMP ,
   CONSTRAINT P_CAPolicyNoPost_NCP PRIMARY KEY (ConfirmSequenceNo)
) IN ${_TBSDATA} INDEX IN ${_TBSINDEX}"
echo "==============================================="
...
times=`date +%s`
main | tee -a Log/1_iaca_ddl_${times}.log
