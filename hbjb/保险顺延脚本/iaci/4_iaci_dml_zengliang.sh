...
#   then
		...
		db2 "update iacmain_ncp  d 
				...
				from   iacmain a
				inner join IATCItemCar b on a.POLICYCONFIRMNO = b.POLICYCONFIRMNO 
				inner join iacmain_ncp e on a.POLICYCONFIRMNO = e.POLICYCONFIRMNO and e.flag = ''
				inner join iaphead f on f.POLICYCONFIRMNO = a.POLICYCONFIRMNO and f.confirmdate >= '${_LASTDATE}' 
